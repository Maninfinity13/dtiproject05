// Object คือ ก้อนวัตถุ เอาใช้กับภาษาโปรแกรมในเรื่องของตัวแปร (variavle)
var data0 = 10 //ตัวแปรธรรมดา แบบ Global
let data1 = 20 //ตัวแปรธรรมดา แบบ Local
const data2 = 30 //ตัวแปรประเถท ค่าคงที่
let data3 = [10, 20, 30, 40] //ตัวแปรอาร์เรย์
let data4 = { //ตัวแปรประเภท objrct
    'a':20, // key : value
    'b':'Hi',
    'c':55.555,
    'd': [1,2,3,4,5],
...
console.log(data4.a)
// อยากได้ผลรวมของ 20 กับ 55.5555 ของ data4
console.log(data4.a + data4.c)
// อยากได้ 4 ขแง data4 แสดงออกมา
